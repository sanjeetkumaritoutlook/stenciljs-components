...
export class MyCard {
  ...
  //   }
//componentDidLoad(): Called when a component is first inserted into the DOM 
//componentWillLoad(): Called once after a component is first connected to the DOM 
  componentWillLoad() {
  ...
  getStencilUserFromAPI() {
    ...
    fetch('https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=IBM&interval=5min&apikey=demo')
      ...
      .then(parsedRes => {
        ...
        var timeDateStencil = timeSeries['2024-10-04 19:55:00'];
  ...
  getReactUserFromAPI() {
    ...
    fetch('https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=IBM&interval=5min&apikey=demo')
      ...
      .then(parsedRes => {
        var timeSeries = parsedRes['Time Series (5min)'];
        var timeDateReact = timeSeries['2024-10-04 19:40:00'];
        console.log(timeSeries);
